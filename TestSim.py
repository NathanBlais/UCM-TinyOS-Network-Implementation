...
#####***TCP Test***##### 
   ...
   # s.runTime(40); #no noise 100, some noise 100
    ...
    # s.runTime(10);
    # s.ping(1, 6, "I'll have you know I gr");
    #s.cmdTestClient(1,8,6,10, "I love puppies!"); #[selfAdress] [srcPort] [dest] [destPort] [transfer]
    #s.runTime(450);  #no noise 350, some noise 350
...
###***Chat Client and Server Test*** ###
    ...
    s.runTime(100);
    s.cmdServerRead(1,1,40);
    #s.cmdChatClientCmd(3, "hello John 3\r\n");
    s.runTime(400);
    #s.cmdServerRead(1,1,50);
